...
import { createServerAdapter as createOllamaAdapter } from "@paperclipai/adapter-ollama-local/server";
...
const ollamaLocalAdapter: ServerAdapterModule = createOllamaAdapter();
